...
Funcionalidade: Venda de produtos para Loja
  ...
  Esquema do Cenário: Cliente quer verificar disponibilidade de um produto
    ...
    # Precisam ficar entre "aspas" para dar match na regex
        ...
        | "tomsmith" | "SuperSecretPassword!"    | "Usuario autenticado" | "Prod 2"  | "Loja 1 tem 5 unidades do Prod 2" |
        ...
        | "tomsmith" | "SuperSecretPassword!"    | "Usuario autenticado" | "Prod 5"  | "Produto não disponível"          |
